<template>
  <div id="SlotMachine">
    ...
    <div class="history" @click="openResultList = true">
      OPEN RESULT
    </div>

    <div
      @click.self="openResultList = false"
      :class="['resultList', { openResultList }]"
    >
    ...
    <div class="github">
      <a href="https://github.com/guahsu/Vue-SlotMachine/" target="_blank">
        → GitHub Source Code
      </a>
    </div>
  </div>
...
const configs = ref([
  {
    style: 'gift-style',
    gifts: Array.from({ length: 10 }, (_, i) => ({ type: 'text', name: i })),
    duration: 4000,
    fontSize: 150,
    height: 200,
    width: 200
...
const turn = () => {
  ...
  disabled.value = true
  trigger.value = new Date() // 通知 Gift 開始轉動
}
